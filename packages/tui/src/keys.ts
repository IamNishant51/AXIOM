...
export function parseKey(data: string): string {
	...
	if (data.startsWith("\x1b[")) {
		...
		// Function keys
		if (seq.startsWith("P")) return "f1";
		if (seq.startsWith("Q")) return "f2";
		if (seq.startsWith("R")) return "f3";
		if (seq.startsWith("S")) return "f4";
		...
		// With ctrl modifier
		if (seq === "1;5A") return "ctrl+up";
		if (seq === "1;5B") return "ctrl+down";
		if (seq === "1;5C") return "ctrl+right";
		if (seq === "1;5D") return "ctrl+left";

		// With alt modifier
		if (seq === "1;3A") return "alt+up";
		if (seq === "1;3B") return "alt+down";
		if (seq === "1;3C") return "alt+right";
		if (seq === "1;3D") return "alt+left";
	}
 ...
 */
export function matchesKey(data: string, pattern: string): boolean {
