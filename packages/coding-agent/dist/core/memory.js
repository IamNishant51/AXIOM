 ...
 */
export async function findMemoryFiles(projectRoot) {
    const memoryFiles = [];
 ...
 */
export async function loadMemoryContext(projectRoot) {
 ...
 */
export async function createMemorySystemPrompt(projectRoot, maxLength = 8000) {
 ...
 */
export function getMemoryIndicator(context) {
    return {
