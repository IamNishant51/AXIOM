...
export const webSearchTool = {
    name: "web_search",
    label: "Web Search",
    description: "Search the internet for information. Use this when you need up-to-date information, facts, or anything not in the local codebase.",
    parameters: Type.Object({
        query: Type.String({ description: "The search query" }),
        limit: Type.Optional(Type.Number({ description: "Maximum number of results (default: 5, max: 10)" })),
    }),
...
export const fetchUrlTool = {
    ...
    parameters: Type.Object({
        ...
        limit: Type.Optional(Type.Number({ description: "Max characters to return (default: 5000, max: 50000)" })),
    }),
    async execute(_toolCallId, params) {
        let url = params.url;
...
export const internetTools = [webSearchTool, fetchUrlTool];
