 ...
 */
export async function checkReadOnly(path) {
    try {
...
export function getCommandCategory(command) {
    ...
    if (lower.includes("docker") || lower.includes("kubectl"))
        return "container";
    if (lower.includes("ssh") || lower.includes("scp"))
        return "remote";
    if (lower.includes("make") || lower.includes("cmake"))
        return "build";
    if (lower.includes("python") || lower.includes("node") || lower.includes("cargo"))
        return "runtime";
